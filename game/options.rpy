...
define config.name = _("The Good Christian Visual Novel")
...
define build.name = "TheGoodChristianVisualNovel"
...
define config.main_menu_music = "titlemusic.mp3"
...
define config.save_directory = "TheGoodChristianVisualNovel-1527204481"
